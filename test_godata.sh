...
docker build --no-cache -t godata-test:latest . && docker run --env DATA_PATH=/home/data --env RUST_BACKTRACE=1 -v $GODATA_TEST_ROOT/test_io/test_data:/home/data -v $GODATA_TEST_ROOT/logs:/home/logs -it godata-test:latest $CMD
