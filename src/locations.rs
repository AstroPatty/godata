...
fn create_collection_dir(name: &str) -> Result<PathBuf> {
    ...
    Err(std::io::Error::new(std::io::ErrorKind::AlreadyExists, format!("Collection {} already exists", name)))
}
...
pub(crate) fn load_collection_dir(name: &str) -> Result<PathBuf> {
    ...
    Err(std::io::Error::new(std::io::ErrorKind::NotFound, format!("Collection {} does not exist", name)))
}
...
pub(crate) fn create_project_dir(name: &str, collection_name: &str, force: bool) -> Result<PathBuf> {
    ...
    Err(std::io::Error::new(std::io::ErrorKind::AlreadyExists, format!("Project {} already exists", name)))
}
...
pub(crate) fn load_project_dir(name: &str, collection_name: &str) -> Result<PathBuf> {
    ...
    Err(std::io::Error::new(std::io::ErrorKind::NotFound, format!("Project {} does not exist", name)))
}
...
pub(crate) fn delete_project_dir(name: &str, collection_name: &str) -> Result<()> {
    ...
    if project_path.exists() {
        ...
        return Err(std::io::Error::new(std::io::ErrorKind::NotFound, format!("Project {} does not exist", name)))
    }
...
pub(crate) fn get_default_project_storage_dir(name: &str, collection_name: &str) -> Result<PathBuf> {
